...
{
	$to = '';
	$subject = 'Enter Your Room Form Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Enter Your Blood Pressure:</b></td><td>' . htmlentities($_REQUEST["custom_U4119"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Enter Your Blood Sugar Level:</b></td><td>' . htmlentities($_REQUEST["Email"],ENT_COMPAT,'UTF-8') . '</td></tr>';
